...
1. Brush flattened dough with a thin layer of oil and sprinkle Sichuan papper and finishing salt.[^2]
1. Spread meat filling (if using).
1. Spread green onions.
...
1. Gather both ends and stretch and twist one full turn until a continuous twist is formed, then fold back and press into self.
...
1. Freeze buns, and steam for ~20min (uncooked) or ~15min (cooked) from frozen when ready to eat (i.e. do not thaw).

[^1]: This is very similar to the [dumpling](dumplings.md) filling, roughly quartered but more oily.
[^2]: The finishing salt is very important; otherwise, the final bun will be too bland.

## Sources

* Leung, Kaitlin. *The Woks of Life*. https://thewoksoflife.com/hua-juan-flower-rolls-scallion-buns/.
* *Chinese Food Hub*. https://www.youtube.com/watch?v=WOCt-4pupLY/.
